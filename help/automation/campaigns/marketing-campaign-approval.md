...
キャンペーンごとに、配信ターゲット、[配信コンテンツ](#approving-content)、費用などを承認できます。承認を担当するAdobe Campaignオペレーターは、E メールで通知を受け、クライアントコンソールから、または Web 接続を介して、承認を許可または却下できます。 [詳細情報](#approving-processes)。
...
承認が必要なステージは、（クライアントコンソールまたは Web インターフェイスを介して）キャンペーンダッシュボードに表示されます。 配信トラッキングテーブルと配信ダッシュボードにも表示されます。
...
1. 通知 E メールがコンテンツの担当者に送信されます。この担当者は、コンテンツを承認するかどうかを選択できます。
   ...
   * クライアントコンソールまたは Web インターフェイス、配信トラッキング、配信ダッシュボードまたはキャンペーンダッシュボードから。 このキャンペーンダッシュボードで「**[!UICONTROL 受信ボックスレンダリング...]**」リンクをクリックして、送信済みの配達確認のリストを表示できます。配達確認の内容を表示するには、リストの右側にある「**[!UICONTROL 詳細]**」アイコンをクリックします。
...
1. その後、クライアントコンソールにログオンし、シンプルなウィザードで配信を開いて編集し、件名、HTML、テキストコンテンツを変更し、配達確認を送信できます。
...
1. 配信コンテンツの変更を完了したら、コンテンツ編集担当者はコンテンツを使用可能にすることができます。
   ...
   * の **[!UICONTROL 利用可能なコンテンツ]** リンクを使用して、Adobe Campaign Client Console にアクセスできます。
   * 通知メッセージ内のリンク。
...
このリンクは、1 つ以上の配達確認が送信済みの場合にのみ表示されます。そうしないと、配信レンダリングはクライアントコンソールまたは Web インターフェイスからのみ使用できます。
...
クライアントコンソールまたは Web インターフェイスからジョブを承認するには、キャンペーンダッシュボードの適切なリンクをクリックします。
...
デフォルトでは、キャンペーンテンプレート、キャンペーンまたは配信で関連ジョブの承認が有効になっている場合に通知メッセージが送信されます。ただし、クライアントコンソールからのみ承認を許可するために、通知を無効にすることもできます。
