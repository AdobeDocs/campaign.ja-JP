...
キャンペーンごとに、配信ターゲット、[配信コンテンツ](#approving-content)、費用などを承認できます。 Adobe Campaign の承認担当オペレーターは、メールで通知を受け、クライアントコンソールまたは web 接続で承認を許可または却下できます。 [詳細情報](#approving-processes)。
