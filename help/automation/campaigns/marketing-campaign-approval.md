...
キャンペーンごとに、配信ターゲット、[配信コンテンツ](#approving-content)、費用などを承認できます。承認を担当するAdobe Campaignオペレーターは、E メールで通知を受け、クライアントコンソールまたは Web ブラウザーから承認を許可または却下できます。 [詳細情報](#approving-processes)。
...
承認が必要な手順は、（クライアントコンソールまたは Web ブラウザーを介して）キャンペーンダッシュボードに表示されます。 配信トラッキングテーブルと配信ダッシュボードにも表示されます。
...
1. 通知メールがコンテンツの担当者に送信されます。この担当者は、コンテンツを承認するかどうかを選択できます。
   ...
   * クライアントコンソールまたは Web ブラウザー、配信トラッキング、配信ダッシュボードまたはキャンペーンダッシュボードから。 このキャンペーンダッシュボードで「**[!UICONTROL 受信ボックスレンダリング...]**」リンクをクリックして、送信済みの配達確認のリストを表示できます。配達確認の内容を表示するには、リストの右側にある「**[!UICONTROL 詳細]**」アイコンをクリックします。
...
1. 配信コンテンツの変更を完了したら、コンテンツ編集担当者はコンテンツを使用可能にすることができます。
   ...
   * の **[!UICONTROL 利用可能なコンテンツ]** リンクを使用して、Adobe Campaignクライアントコンソールにアクセスできます。
   * 通知メッセージ内のリンク。
...
このオプションを使用して、ブランド通信の一貫性、率など、配信レンダリングの承認を担当する外部オペレーターを定義できます。 次の場合に **[!UICONTROL 外部コンテンツの承認]** 承認設定ウィンドウで「 」オプションを選択した場合、コンテンツの承認とキャンペーン担当者への通知の配信の間に、次の承認手順が追加されます。
...
このリンクは、1 つ以上の配達確認が送信済みの場合にのみ表示されます。そうしないと、配信レンダリングはクライアントコンソールまたは Web ブラウザーからのみ使用できます。
...
クライアントコンソールまたは Web ブラウザーを使用してジョブを承認するには、キャンペーンダッシュボードの適切なリンクをクリックします。
