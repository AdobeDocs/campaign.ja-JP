...
Adobe Analytics の **分散型マーケティング** 「 」タブでは、インターフェイスのタイプを選択し、ローカルエンティティがインターフェイスをオーダーする際に入力するデフォルトの値とパラメーターを指定できます。

インターフェイスは、キャンペーンのオーダー時にローカルエンティティが入力するフォームに対応します。

テンプレートから作成されるキャンペーンに適用されるインターフェイスのタイプを選択します。

![](assets/mkt_distr_1.png)

次の 4 種類のインターフェイスを使用できます。
...
オーダーの承認は、キャンペーンのオーダーの概要で、クライアントコンソールからおこなうこともできます。 オーダーを承認するには、オーダーを選択して、「**[!UICONTROL オーダーを承認]**」をクリックします。
...
却下の情報は、キャンペーンパッケージのリストのページやキャンペーンのオーダーのページにも表示されます。Adobe Campaignクライアントコンソールにアクセスできるローカルエンティティは、この却下の情報を通知します。
