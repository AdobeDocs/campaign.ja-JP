...
* **セントラルエンティティ**
   ...
   * ローカルエンティティに提供するマーケティングキャンペーンパッケージをセットアップします。
...
各組織エンティティには、識別情報（ラベル、内部名、連絡先情報など）が含まれます。 発注承認プロセスに関与するグループなどです。 これらの情報は、「**[!UICONTROL 一般]**」タブの「**[!UICONTROL 通知と承認]**」セクションで定義されます。
