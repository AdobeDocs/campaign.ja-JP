...
この種のフィールドに関する、入力値の定義や全般的な管理作業（値の追加や削除）は、ツリーの&#x200B;**[!UICONTROL 管理／プラットフォーム／列挙]**&#x200B;ノードで行なわれます。

![列挙へのアクセス](assets/enumerations-menu.png)
...
この列挙に基づくすべてのフィールドについて、ユーザーが（Adobe Campaign コンソールの web フォームの）「会社」フィールドに **Adob** と入力すると、**Adobe** という値に自動置換されます。
