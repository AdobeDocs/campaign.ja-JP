...
1. **[!UICONTROL 使用可能フィールド]**&#x200B;リストに追加するフィールドをダブルクリックします。これらのフィールドは、**[!UICONTROL 出力列]**&#x200B;リストに追加されます。
   ...
   >
   >フィールドは、SQL フィールド、リンクされたテーブル、計算フィールドなどの特定のアイコンで識別されます。選択した各フィールドに対して、説明が使用可能なフィールドのリストに表示されます。
   >
...
1. 並べ替えの優先度は、並べ替え列の順序を使用して定義されます。 優先度を変更するには、適切なアイコンを使用して列の順序を変更します。
...
* **[Campaign ユーザーインターフェイスから開始](../start/campaign-ui.md)** - Adobe Campaign インターフェイスにアクセスして参照する方法について説明します。
