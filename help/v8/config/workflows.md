...
>[!NOTE]
>
>Adobe Campaignのweb ユーザーインターフェイスには、ワークフロー用のキャンバスが刷新され、より動的でパーソナライズされたカスタマージャーニーを構築できるようになりました。 Web UI のワークフローについて詳しくは、[Adobe Campaign web UI ドキュメント](https://experienceleague.adobe.com/ja/docs/campaign-web/v8/wf/gs-workflows){target=_blank}を参照してください。
...
* [マーケティングキャンペーンワークフローでオーディエンスを構築する](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-target.html?lang=ja){target="_blank"}
...
Campaign ワークフロー機能[を活用したユースケースについて、この節](../../automation/workflow/workflow-use-cases.md)で説明します。
