...
* `load(id)` - IDでエンティティを読み込みます。 [詳細情報](https://experienceleague.adobe.com/ja/tools/campaign-api){target="_blank"}
...
[BuildQuery](https://experienceleague.adobe.com/ja/tools/campaign-api){target="_blank"}の詳細をご覧ください。
...
[BuildQueryEx](https://experienceleague.adobe.com/ja/tools/campaign-api){target="_blank"}の詳細をご覧ください。
...
[SelectAll](https://experienceleague.adobe.com/ja/tools/campaign-api){target="_blank"}の詳細をご覧ください。
...
[GetInstanceFromModel](https://experienceleague.adobe.com/ja/tools/campaign-api){target="_blank"}の詳細をご覧ください。
...
* [queryDef API リファレンス](https://experienceleague.adobe.com/ja/tools/campaign-api){target="_blank"}
