...
Web フォームを作成して公開する方法について詳しくは、[Campaign Classic v7 ドキュメント](https://experienceleague.adobe.com/docs/campaign-classic/using/designing-content/web-forms/about-web-forms.html?lang=jal#designing-content){target="_blank"}を参照してください。
...
Web アプリケーションを作成して公開する方法について詳しくは、[Campaign Classic v7 ドキュメント](https://experienceleague.adobe.com/docs/campaign-classic/using/designing-content/web-applications/about-web-applications.html?lang=ja#designing-content){target="_blank"}を参照してください。
