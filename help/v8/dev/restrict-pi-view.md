...
* **[!UICONTROL visibleIf]**: メタデータからフィールドを非表示にします。したがって、スキーマビュー、列選択、または[式ビルダー](../../v8/start/filter-conditions.md#list-of-functions)内ではフィールドにアクセスできません。 ただし、フィールド名を式に手動で入力した場合は、値が表示され、データは非表示にはなりません。
