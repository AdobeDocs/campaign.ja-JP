...
ペイロード内の目的のサービスプライマリキーを使用して、サブスクリプション URLに対してPOST リクエストを実行します。
...
サービスノードが完了した状態で、更新されたプロファイルを返します。
...
ペイロード内の目的のプロファイルプライマリキーを使用して、サブスクリプション URLに対してPOST リクエストを実行します。
...
サブスクライバーノードが完了した状態で、更新されたサービスを返します。
