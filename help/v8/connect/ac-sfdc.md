...
1. Salesforce 列挙に対応する Adobe Campaign 列挙を選択します。
...
1. **[!UICONTROL 管理／プラットフォーム／列挙]**&#x200B;ノードを参照し、インポートされた値を確認します。 列挙について詳しくは、[このページ](../config/ui-settings.md#enumerations)を参照してください。
