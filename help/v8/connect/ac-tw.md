...
Campaign は、Twitter API の 1.1 バージョンを使用します。 これを使用するには、開発者ポータル経由で管理者特権でのアクセス権を申請する必要があります。Twitter 管理者特権でのアクセス権については、[このページ](https://developer.twitter.com/en/portal/products/elevated){target=&quot;_blank&quot;}を参照してください。
