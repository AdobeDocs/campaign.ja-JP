...
Experience Cloud トリガー](https://experienceleague.adobe.com/docs/experience-cloud/triggers/create.html?lang=ja){target="_blank"}を[作成し、重要な消費者行動を特定、定義、監視する方法について説明します。
