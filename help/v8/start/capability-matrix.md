...
### キャンペーンとSnowflake{#ac-gs-snowflake}

クラウドストレージは、次のSnowflakeで実行されます。新しい外部アカウントは、Cloud Databaseとの接続を確保します。 [詳細情報](#ac-gs-snowflake)。
...
これらの拡張機能は、組み込みのスキーマをキャンペーンのローカルデータベースからSnowflakeのクラウドデータベースに移動し、それに応じて構造を調整するために必要な変更を含みます。新しいUUID、更新されたリンクなど
