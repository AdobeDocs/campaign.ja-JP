...
[Campaign v8 でオーディエンスを定義 &#x200B;](../audiences/gs-audiences.md) する方法を説明します。
...
1. テンプレートから配信を作成
2. オーディエンス（クエリ、リスト、ワークフロー）の定義
3. パーソナライゼーションを使用したコンテンツのデザイン
4. 検証するテスト配達確認の送信
5. 分析の実行と送信

Campaign v8 には、**クライアントコンソール** （フル機能）と **Campaign web UI** （最新、直感的）の 2 つのインターフェイスがあります。
