...
[&#x200B; 除外アクティビティ &#x200B;](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/exclusion.html?lang=ja){target="_blank"}
...
[&#x200B; 記述的分析 &#x200B;](../reporting/built-in-reports.md) を参照してください。
...
[&#x200B; カスタムレポートの作成（クライアントコンソール） &#x200B;](../reporting/custom-reports.md) を参照してください。
...
[&#x200B; キューブを使用したデータの調査 &#x200B;](../reporting/gs-cubes.md) を参照してください。
...
[&#x200B; データパッケージの操作 &#x200B;](../dev/packages.md) を参照してください。
...
[&#x200B; プライバシーの管理 &#x200B;](../start/privacy.md) を参照してください。
