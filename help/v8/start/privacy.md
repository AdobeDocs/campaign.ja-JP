...
プライバシーリクエストの実行時に考慮されるビルトインのテーブルのリストは、次のとおりです。
...
* [プライバシー管理を始めましょう](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/privacy/privacy-management.html?lang=ja){target="_blank"}
