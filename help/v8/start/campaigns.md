...
でマーケティングキャンペーンにアクセスして実装する方法を説明します [この節](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/set-up-campaigns.html?lang=ja){target="_blank"}.
...
1. **マーケティングプログラムおよびキャンペーンの計画と設計**
   ...
   でマーケティングプランを作成しキャンペーンを設定する方法を説明します [このページ](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-create.html?lang=ja){target="_blank"}.
   ...
   でキャンペーンテンプレートを使用する方法を学ぶ [このページ](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-templates.html?lang=ja){target="_blank"}.

   繰り返しキャンペーンとでの設定方法を確認する [このページ](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/recurring-periodic-campaigns.html?lang=ja){target="_blank"}.
...
1. **オーディエンスの定義**
   ...
   でメッセージのオーディエンスを定義する方法を学ぶ [このページ](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-target.html?lang=ja){target="_blank"}.
...
1. **配信の作成**
   ...
   でマーケティングキャンペーン配信を作成し開始する方法を説明します。 [このページ](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-deliveries.html?lang=ja){target="_blank"}.

   レポート、写真、web ページ、図などの様々なドキュメントをキャンペーンに関連付けることができます。

   関連するドキュメントの詳細： [このページ](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-assets.html?lang=ja){target="_blank"}.
...
1. **承認プロセスの設定**
   ...
   で承認を設定および管理する方法について説明します [このページ](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-approval.html?lang=ja#campaign-orchestration){target="_blank"}.
...
で Campaign 分散型マーケティング機能を設定および使用する方法について説明します。 [このページ](https://experienceleague.adobe.com/docs/campaign/automation/distributed-marketing/about-distributed-marketing.html?lang=ja){target="_blank"}.
...
[](../assets/do-not-localize/book.png) で Campaign Response Manager を設定および使用する方法について説明します。 [Campaign Classic v7 ドキュメント](https://experienceleague.adobe.com/docs/campaign-classic/using/response-manager/about-response-manager.html?lang=ja){target="_blank"}.
