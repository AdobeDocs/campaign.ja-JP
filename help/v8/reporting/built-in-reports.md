---
title: Adobe Campaign のビルトインのレポート
...
# Adobe Campaign のビルトインのレポート {#ootb-reports}

このページでは、Adobe Campaign のビルトインのレポートとそれらの内容およびコンテキストの一覧を示します。 Adobe Campaign には、クライアントコンソールまたはインターネットブラウザーからアクセスできる、様々なビルトインのレポートが用意されています。
...
ビルトインのレポートには、Campaign のホームページ、専用のレポートダッシュボードまたは配信リストからアクセスできます。 UI でのレポートの表示方法は、そのコンテキストに応じて異なります。
...
次のレポートも組み込まれています。 詳しくは、関連する機能に関するドキュメントを参照してください。
