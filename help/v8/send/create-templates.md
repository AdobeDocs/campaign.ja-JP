...
各配信は、テンプレートに基づいて作成されます。 テンプレートは、実装を容易にし、標準化するのに再利用できる設定です。 ビルトインのテンプレートまたはカスタムテンプレートを使用できます。
...
1. Adobe Campaign **ビルトインの**&#x200B;配信テンプレート - ビルトインのテンプレートは各チャネルで使用できます。 変更または削除しないでください。 各配信チャネルの基本設定が含まれています。 管理者は、デフォルト値を設定するか、トラッキングパラメーターや送信者のメールアドレスの変更など、特定の機能をエンドユーザーに制限できます。 ビルトインのテンプレートは、テンプレートのリストに太字で表示されます。
...
Campaign には、各チャネル用の一連のビルトインのテンプレート（メール、プッシュ、SMS、ダイレクトメールなど）が付属しています。
...
1. ビルトインの配信テンプレートを選択します。 ビルトインのテンプレートはリスト内で太字で表示されています。
...
1. **HTML コンテンツ**&#x200B;を追加してテンプレートをパーソナライズします。[ミラーページのリンク](../send/mirror-page.md)と購読解除リンクを表示することもできます。
