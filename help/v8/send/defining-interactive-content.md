---
product: campaign
title: Adobe Campaign でのインタラクティブコンテンツの定義
...
新しい **AMP for Email** フォーマットを使用すると、メッセージに AMP コンポーネントを組み込み、アクションにつながるリッチコンテンツでメールエクスペリエンスを向上させることができます。 最新のアプリ機能を直接メール内に組み込めるため、受信者はメッセージ内にあるコンテンツと動的にやりとりすることができます。
...
## AMP メールのターゲット {#targeting-amp-email}
...
Gmail の場合、まずはターゲットにする Gmail アカウント用に Adobe Campaign からの配信に使用する送信者のアドレスを許可リストに追加する必要があります。
