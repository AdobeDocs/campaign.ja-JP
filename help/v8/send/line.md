...
![](../assets/do-not-localize/book.png) 詳しくは、 [エンドツーエンドのサンプル](https://experienceleague.adobe.com/docs/campaign-classic/using/sending-messages/line-channel.html?lang=ja#example--create-and-send-a-personalized-line-message)最初の LINE 配信を作成して送信するためのCampaign Classicv7 ドキュメントの {target=&quot;_blank&quot;}。
